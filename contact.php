...
<html>
	...
	<body>
        ...
        <!--==home slider==-->
        <div class="slider">
            <div><img class="slider_a" src="images/contact.jpg" all="slider" usemap="#workmap"></div>
            <map name="workmap">
        ...
        <div id=mid>
            <h1>CONTACT</h1>
            <p>EMAIL: CONTACT@FROMAGEETPANTOUFLES.FR</P>
            <p>TELEPHONE: +3365142578</P>
            <p>FAX: +3365142577</P>
            <p>ADRESSE: 96 BD BESSIERES</P>
        </div>
        <!--== Footer ==-->
		<footer>
